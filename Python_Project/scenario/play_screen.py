...
GENERAL_BLEU = "turtle"       # Modifier ici
GENERAL_ROUGE = "daft"  # Modifier ici


def initialiser_partie(general_bleu="daft", general_rouge="braindead"):
...
if __name__ == "__main__":
    ...
    paused = True
    game_tick = 0
    tournoi=Tournament(mon_jeu.generaux,["BraindeadVSDAFT"])
    ...
    while running:
        ...
        if not paused and not partie_terminee:
            ...
            if game_tick >= 10:
                ...
                # if tournoi and gagnant:
                #     vainqueur = mon_jeu.generaux[0].name if gagnant == 1 else mon_jeu.generaux[1].name
